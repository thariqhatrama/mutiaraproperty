                ...
                <div class="col-md-4 d-flex align-items-stretch">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Hunian nyaman elit dan terjangkau di Jakarta dengan fasilitas lengkap di
                                Mutiara Residence Pondok Cabe.</p>
                ...
                <div class="col-md-4 d-flex align-items-stretch">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Temukan keuntungan memiliki rumah cluster, desain minimalis modern yang
                                ideal
                                untuk hunian pertama.</p>
                ...
                <div class="col-md-4 d-flex align-items-stretch">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Dapatkan inspirasi warna cat rumah yang cantik dan populer untuk membuat
                                rumah
                                Anda tampak lebih hidup.</p>
